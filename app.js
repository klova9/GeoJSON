...
function initMap() {
  ...
  map.data.loadGeoJson('https://raw.githubusercontent.com/klova9/GeoJSON/master/stores.json?token=AQHYSFIJ3EILAHE2OEWGH4S7DHE46');
  ...
  map.data.setStyle((feature) => {
    return {
        icon: {
            url: `https://storage.googleapis.com/intricate-abbey-270323.appspot.com/img/icon_store.png`,
        scaledSize: new google.maps.Size(64, 64),
      },
    };
  });

    const apiKey = 'AIzaSyC4FF4vXEbKGuztsY96mFjGv3qiD0wC-6A';
